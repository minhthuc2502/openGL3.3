...
void window::initialize() {
  ...
  // using open gl core proifle to opengl more effective and flexible but more
  // difficult => need to use it
  ...
  /**
   * call glad to manage all function of OpenGL that we want to use before call
   * function openGL glfw provide glfwGetProcAddress to define correct function
   * base on OS compile for glad load adress of the OpenGL function pointers.
   */
