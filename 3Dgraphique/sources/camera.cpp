...
void camera::setCameraPos(glm::vec3 cpos) { cameraPos = cpos; }

void camera::setWorldUp(glm::vec3 cup) { worldUp = cup; }
...
float camera::getPitch(void) { return Pitch; }

float camera::getYaw(void) { return Yaw; }

float camera::getFov(void) { return Fov; }

glm::vec3 camera::getCameraPos(void) { return cameraPos; }
